                        ...
                        <div className="p-4 md:p-6 border-b border-white/5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <div className="relative w-full sm:w-auto">
                                ...
                                <input
                                    ...
                                    className="bg-[#0b0f19] border border-white/10 rounded-xl pl-10 pr-4 py-2 text-sm text-white focus:ring-2 focus:ring-cyan-500/50 outline-none w-full sm:w-64 transition"
                                />
                            </div>
                        </div>
