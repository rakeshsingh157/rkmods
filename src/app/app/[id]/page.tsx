                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start">
                        <div className="w-28 h-28 sm:w-36 sm:h-36 md:w-48 md:h-48 rounded-2xl md:rounded-3xl bg-[#131b2e] flex-shrink-0 overflow-hidden shadow-2xl shadow-cyan-500/20 border border-white/10 relative group">
                            {app.icon_url ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-gray-600 text-sm">No Icon</div>
                            )}
                        ...
                        <div className="flex-1 text-center md:text-left w-full">
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 md:gap-6 text-xs md:text-sm text-gray-400 mb-6 md:mb-8">
                                <div className="flex items-center gap-2 bg-white/5 px-3 md:px-4 py-2 rounded-xl border border-white/5 backdrop-blur-sm hover:bg-white/10 transition">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4 justify-center md:justify-start">
                                <a
                                    ...
                                    className="w-full sm:flex-1 md:flex-none inline-flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold text-base md:text-lg hover:shadow-lg hover:shadow-cyan-500/30 transition transform hover:-translate-y-1 active:scale-95"
                                >
            ...
            <div className="container mx-auto px-4 md:px-6 py-8 md:py-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
                            ...
                            <div className="space-y-3 md:space-y-4 mt-6 md:mt-8">
                                {reviews.map((review: any) => (
                                    <div key={review.id} className="bg-[#131b2e] p-4 md:p-6 rounded-xl md:rounded-2xl border border-white/5 shadow-sm hover:border-white/10 hover:shadow-lg transition group">
                                        ...
                                        <p className="text-gray-400 text-sm md:text-base leading-relaxed">{review.message}</p>
                    ...
                    <div className="space-y-6 md:space-y-8 lg:sticky lg:top-24 lg:self-start">
                        {/* App Info Card */}
                        <div className="bg-[#131b2e] p-5 md:p-6 rounded-2xl md:rounded-3xl border border-white/5 shadow-lg hover:border-white/10 transition animate-fadeIn" style={{animationDelay: '0.3s'}}>
